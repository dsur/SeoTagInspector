  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6">
      <Tabs defaultValue="google" onValueChange={setActiveTab} value={activeTab}>
        ...
        <TabsContent value="google" className="p-6 md:p-8 focus:outline-none">
          <GooglePreview analysisResult={analysisResult} />
        </TabsContent>
        
        <TabsContent value="facebook" className="p-6 md:p-8 focus:outline-none">
          <FacebookPreview analysisResult={analysisResult} />
        </TabsContent>
        
        <TabsContent value="twitter" className="p-6 md:p-8 focus:outline-none">
          <TwitterPreview analysisResult={analysisResult} />
        </TabsContent>
        
        <TabsContent value="linkedin" className="p-6 md:p-8 focus:outline-none">
